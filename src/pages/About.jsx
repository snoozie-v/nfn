    ...
    <div>
      <div className="font-mono justify-center text-blue-50">
          <div className='bg-slate-800 justify-center'>
                ...
                <img src={heroabout} className='justify-center'/>
                <div className='text-blue-50 p-2'>
                ...
                <div className='p-4 sm:grid sm:grid-cols-2 gap-2'>
                <img src={tricky} className='sm:pl-12 w-120 h-[480px] p-4'></img>
                ...
                <img src={tdogg} className='sm:pl-12 w-[410px] h-[480px] p-4'></img>
                ...
                <img src={snoozie} className='sm:pl-12 w-[410px] p-4'></img>
